...
export default function StudentHomePage() {
  ...
  // semesters: [{ semesterName, semesterId, subjects: [{ subjectId, subjectName }] }]
  ...
  const filtered = useMemo(() => {
    if (selectedSemester === "All Semesters") return semesters;
    return semesters.filter((s) => s.semesterName === selectedSemester);
