...
const semestersData = [
  { id: 1, name: 'Spring 2024', range: 'Jan â€“ May', courses: 124, docs: 128, storage: '320 MB', status: 'ACTIVE',   startDate: '29/04/2026', endDate: '29/04/2027', description: 'Standard Spring term encompassing core curriculum and undergraduate electives.' },
  { id: 2, name: 'Summer 2024', range: 'Jun â€“ Aug', courses: 38,  docs: 45,  storage: '110 MB', status: 'ACTIVE',   startDate: '01/06/2024', endDate: '31/08/2024', description: '' },
  { id: 3, name: 'Fall 2024',   range: 'Sep â€“ Dec', courses: 56,  docs: 96,  storage: '280 MB', status: 'ACTIVE',   startDate: '01/09/2024', endDate: '20/12/2024', description: '' },
  { id: 4, name: 'Spring 2025', range: 'Jan â€“ May', courses: 89,  docs: 104, storage: '410 MB', status: 'ACTIVE',   startDate: '15/01/2025', endDate: '30/05/2025', description: '' },
  { id: 5, name: 'Fall 2023',   range: 'Sep â€“ Dec', courses: 42,  docs: 87,  storage: '260 MB', status: 'ARCHIVED', startDate: '01/09/2023', endDate: '20/12/2023', description: '' },
];
...
const coursesData = {
  ...
  4: [
    ...
    { id: 7, name: 'Advanced Algebra',            code: 'MATH-401', instructor: 'Prof. Ã‰variste Galois', docs: 14, updated: 'Apr 30, 2025', status: 'Active',   icon: 'calc',    color: '#fef3c7', iconColor: '#d97706' },
...
function LibraryManagementPage() {
  ...
  // â”€â”€ COURSES PAGE (early return) â”€â”€
  if (selectedSemester) {
    ...
    return (
      <div className="lib-page">
        ...
        {/* Back link */}
        <button className="lib-courses-back" type="button" onClick={() => { setSelectedSemester(null); setSelectedCourses([]); setPage(1); }}>
