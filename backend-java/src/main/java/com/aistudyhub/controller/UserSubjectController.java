...
public class UserSubjectController {
    ...
    public ResponseEntity<List<UserSubjectResponse>> getByUser(@PathVariable Integer userId) {
        return ResponseEntity.ok(userSubjectService.getByUser(userId));
    }
    ...
    public ResponseEntity<UserSubjectResponse> add(@RequestParam Integer userId,
        ...
        return ResponseEntity.ok(userSubjectService.add(userId, subjectId));
    }
    ...
    public ResponseEntity<Void> remove(@RequestParam Integer userId,
                                       @RequestParam Integer subjectId) {
        documentService.deleteAllByUserAndSubject(userId, subjectId);
        userSubjectService.removeLink(userId, subjectId);
